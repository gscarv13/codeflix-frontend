...
export const Banner = () => (
  <div className='mb-10'>
    <div className='flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12'>
      <div className='absolute left-0 top-0 -z-10 flex h-[95vh] w-screen flex-col bg-cyan-500'>
        <Image
          src='/avatar.jpg'
          alt='hero'
          fill={true}
      ...
      <p className='text-shadow-md max-w-xs text-xs md:max-w-lg md:text-lg lg:max-w-2xl'>
        ...
        dolores modi at a alias iusto esse quidem! Quo libero laborum ex
        veritatis voluptatem, sequi nisi? Explicabo quidem dignissimos quasi!
        Aspernatur.
      </p>
    </div>
